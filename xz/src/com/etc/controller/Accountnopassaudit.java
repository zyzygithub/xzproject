...
/**
 * Servlet implementation class Accountnopassaudit
 */
@WebServlet("/Accountnopassaudit")
public class Accountnopassaudit extends HttpServlet {
		...
		String flag =request.getParameter("flag");
		  ...
		  if(flag.equals("allup")) {
			  account_goods_goodstypeserives agg=new account_goods_goodstypeserives();
				...
				request.getRequestDispatcher("accountnopassaudit.jsp").forward(request, response);
				return;
